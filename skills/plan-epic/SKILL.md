...
- **Decide, do not build.** Every ticket resolves a question. The map is finished when nothing is left to decide before someone builds the thing. Wanting to start building is the sign the map is finished, not permission to build.
