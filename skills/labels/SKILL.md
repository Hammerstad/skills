---
name: labels
description: Internal reference for the GitHub labels that drive the skill workflow. The other skills load it whenever they apply or trust a label; invoke it directly only to ask what a label means or what state an issue or PR is in.
---
