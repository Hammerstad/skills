...
- **No forced findings.** Code that's fine is fine — say so and stop.
...
2. **Sweep the heuristics** against the hot paths, keeping only evidence-backed findings:
